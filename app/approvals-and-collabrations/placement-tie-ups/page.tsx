...
const PlacementTieUpsPage = () => {
  ...
  return (
    <>
      ...
      <div className="container mx-auto py-8 px-10 flex flex-col gap-4 text-gray-700">
        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <p>
              ...
              with access to a range of resources and guidance, enabling you to
              empower your entrepreneurial dream with confidence.
            </p>
          </div>
          ...
          <div className="flex flex-col gap-2">
            <h3 className="text-xl font-bold"> Campus Placement & Job Fairs</h3>
            <p>
              {`
