...
const products: ProductType[] = [
    ...
    ,
    {
        ...
        link: ['B-111,lorem ,lorem ipsum,111000 ', 'D-111,lorem ,lorem ipsum,123123']
    }
]
            ...
            <div className="container mx-auto">
                <div className="grid grid-cols-1 py-5 gap-y-10 sm:grid-cols-6 lg:grid-cols-12">
                    <div className='sm:col-span-6 lg:col-span-5'>
                        ...
                        <h3 className='text-xs font-medium text-gray-800 lh-160 mt-5 mb-4 lg:mb-16 pr-10'>{CMP_TITLE} is dedicated to empowering learners by offering accessible, high-quality education and skill development opportunities worldwide</h3>
                ...
                <div className='py-3 md:flex items-center justify-between border-t border-t-gray-blue'>
                    <h4 className='text-dark-red opacity-75 text-sm text-center md:text-start font-normal'>@2023.{CMP_TITLE}.All rights reserved</h4>
